...
*/
        ...
        public void Actual()
        {
            var expected = "96de9657665675b51cd03f0b3528ba26";
            var input = Input;
        ...
        private string Calculate(string input, int listSize = 256)
        {
        ...
        private string Input = "212,254,178,237,2,0,1,54,167,92,117,125,255,61,159,164";
    }
}
