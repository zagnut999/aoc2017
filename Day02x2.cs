...
{
    public class Day02x2
    {
        private readonly ITestOutputHelper output;
        public Day02x2(ITestOutputHelper output)
        {
            this.output = output;
        }
        ...
        {
            var expected = 9;
            var input = new List<string> { "5 9 2 8", "9 4 7 3", "3 8 6 5" };

            var actual = CheckSum(input);
        ...
        private int CheckSum(List<string> input)
        {
            var checksum = 0;
