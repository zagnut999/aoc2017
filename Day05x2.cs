...
namespace AdventOfCode
{
    public class Day05x2
    {
        ...
        */
        ...
        private int Process(List<int> jumpList)
        {
            var current = 0;
            var steps = 0;
            while (current >= 0 && current <jumpList.Count)
            {
                var instruction = jumpList[current];
